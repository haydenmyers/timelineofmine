...
@else
    ...
    @php /* TODO: provide a route for uncategorised events */ @endphp
    <a href="{{ route('home') }}" class="group inline-flex justify-center items-center px-3 py-1 rounded-full border-2 text-gray-700">
        <span class="text-gray-700 pr-2 group-hover:text-black">{{ $slot }}</span>
    </a>
